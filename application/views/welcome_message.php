...
<body>
 ...
 <!--Boton Login-->
              ...
              <form action="<?= base_url('index.php/login/validar') ?>" method="post">
                <label for="" class="input-group-addon">Usuario</label>
                <input required type="text" name="Usuario" class="form-control" >
           <label for="" class="input-group-addon">Password</label>
                <input required type="text" name="Password" class="form-control" >
           <input type="button" name="Entrar" value="Entrar" class="btn btn-primary btn-round-sm">
              ...
              <ul class="nav topnav">
                <li class="dropdown success active">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url()?>index.php/Welcome/index2">Voy a index2</a></li>
                    <li><a href="<?php echo base_url()?>index.php/Welcome/index3">Productos</a></li>
                  </ul>
                </li>
            ...
            <div class="carousel-wrapper">
              ...
              <ul class="portfolio-home da-thumbs">
                <li>
                  <div class="thumbnail">
                    <div class="image-wrapp">
                      <img src="assets/img/dummies/work1s.jpg" alt="Portfolio name" title="" />
                ...
                <li>
                  <div class="thumbnail">
                    <div class="image-wrapp">
                      <img src="assets/img/dummies/work2s.jpg" alt="Portfolio name" title="" />
                      <article class="da-animate da-slideFromRight" style="display: block;">
                        <a class="link_post" href="portfolio-detail.html"><img src="assets/img/icons/link_post_icon.png" alt="" /></a>
                        <span><a class="zoom" data-pretty="prettyPhoto" href="assets/img/dummies/big1.jpg"><img src="assets/img/icons/zoom_icon.png" alt="Portfolio name" title="Portfolio name" /></a></span>
                      </article>
                ...
                <li>
                  <div class="thumbnail">
                    <div class="image-wrapp">
                      <img src="assets/img/dummies/work3s.jpg" alt="Portfolio name" title="" />
                      <article class="da-animate da-slideFromRight" style="display: block;">
                        <a class="link_post" href="portfolio-detail.html"><img src="assets/img/icons/link_post_icon.png" alt="" /></a>
                        <span><a class="zoom" data-pretty="prettyPhoto" href="assets/img/dummies/big1.jpg"><img src="assets/img/icons/zoom_icon.png" alt="Portfolio name" title="Portfolio name" /></a></span>
                      </article>
                ...
                <li>
                  <div class="thumbnail">
                    <div class="image-wrapp">
                      <img src="assets/img/dummies/work4s.jpg" alt="Portfolio name" title="" />
                      <article class="da-animate da-slideFromRight" style="display: block;">
                        <a class="link_post" href="portfolio-detail.html"><img src="assets/img/icons/link_post_icon.png" alt="" /></a>
                        <span><a class="zoom" data-pretty="prettyPhoto" href="assets/img/dummies/big1.jpg"><img src="assets/img/icons/zoom_icon.png" alt="Portfolio name" title="Portfolio name" /></a></span>
                      </article>
